using DHNet.Controllers.Administration;
using System;
using System.Web.Mvc;
using System.Web.Routing;
using Xunit;

namespace DHNet.Tests.Unit.Controllers.Administration
{
    public class AdministrationAreaRegistrationTests
    {
        ...
        public void RegisterArea_MultilingualRoute()
        {
            ...
            Assert.Equal(new[] { "DHNet.Controllers.Administration" }, actual.DataTokens["Namespaces"] as String[]);
