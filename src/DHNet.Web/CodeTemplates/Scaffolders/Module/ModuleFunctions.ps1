Function Scaffold-CsTemplate([String]$Template, [String]$Project, [String]$OutputPath)
{
    ...
    $ControllerNamespace = "DHNet.Controllers"
    $ControllerTestsNamespace = "DHNet.Tests.Unit.Controllers"
    If ($Area) { $ControllerNamespace = "DHNet.Controllers.$Area" }
    If ($Area) { $ControllerTestsNamespace = "DHNet.Tests.Unit.Controllers.$Area" }
...
Function Scaffold-AreaRegistration([String]$Template, [String]$Project, [String]$OutputPath)
{
    if (!$Delete)
    {
        $ControllerNamespace = "DHNet.Controllers.$Area"
        $ControllerTestsNamespace = "DHNet.Tests.Unit.Controllers.$Area"
