...
$DataProject = "DHNet.Data"
$TestsProject = "DHNet.Tests"
$RazorViewProject = "DHNet.Web"
$ObjectsProject = "DHNet.Objects"
$ServiceProject = "DHNet.Services"
$ValidatorProject = "DHNet.Validators"
$ControllerProject = "DHNet.Controllers"
