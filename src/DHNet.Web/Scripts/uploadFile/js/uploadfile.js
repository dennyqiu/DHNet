$(function () {
    ...
    $('.up_load_file').uploadfile({
        ...
        success: function (fileName) {
            alert(fileName + $.fn.uploadfile.lang.Success);
        },
        error: function (fileName) {
            alert(fileName + $.fn.uploadfile.lang.Error);
        },
        complete: function () {
            alert($.fn.uploadfile.lang.Complete);
        }
    });
	...
	$.fn.uploadfile = function (setting) {
		...
		$(this).each(function (i, item) {
			...
			if(setting.canDrag){
				...
				demoHtml +=                         '<button>'+$.fn.uploadfile.lang.Btn+'</button>';
				demoHtml +=						'</div>';
				demoHtml +=					'</div>';
				demoHtml +=					'<div class="file_drag">';
				demoHtml +=                     '<span>' + $.fn.uploadfile.lang.file_drag + '</span>';
				demoHtml +=					'</div>';
				demoHtml +=				'</div>';
				demoHtml +=				'<div class="file_info_handle">';
				demoHtml +=					'<div class="file_info">';
				demoHtml +=                     $.fn.uploadfile.lang.file_info + '<span class="file_count">0</span>' + $.fn.uploadfile.lang.file_count + '<span class="file_size">0</span>KB。';
				demoHtml +=						'<input type="file"/>';
				demoHtml +=                     '<button class="continue_sel">' + $.fn.uploadfile.lang.continue_sel + '</button>';
				demoHtml +=                     '<button class="uploadfile">' + $.fn.uploadfile.lang.uploadfile + '</button>';
				demoHtml +=					'</div>';
				demoHtml +=				'</div>';
