...
namespace Angle
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/demoFlotSample").Include(
                "~/Scripts/demo/demo-flot-Sample.js"
            ));
            ...
            bundles.Add(new ScriptBundle("~/bundles/Highcharts").Include(
                "~/Vendor/Highcharts-4.2.6/js/highcharts.js",
                "~/Vendor/Highcharts-4.2.6/js/modules/exporting.js",
                "~/Vendor/Highcharts-4.2.6/js/highcharts-more.js",
                "~/Vendor/Highcharts-4.2.6/highchart.js",
                "~/Vendor/Highcharts-4.2.6/jDataChart.js"
            ));
